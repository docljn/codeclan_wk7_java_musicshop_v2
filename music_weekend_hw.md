...
1. Create a IPlayable interface to be implemented by instruments. This should require play method that returns the sound of the instrument being played as a String.
